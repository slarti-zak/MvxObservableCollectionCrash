...
{
    public class BatchObservableCollection<T> : ObservableCollection<T>, IObservableCollection<T>
    {
        private struct SuppressEventsDisposable : IDisposable
        {
            private readonly BatchObservableCollection<T> _collection;

            public SuppressEventsDisposable(BatchObservableCollection<T> collection)
            {
        ...
        private bool EventsAreSuppressed
        {
        ...
        /// <summary>
        /// Adds the specified items collection to the current <see cref="BatchObservableCollection{T}"/> instance.
        /// </summary>
        /// <param name="items">The collection from which the items are copied.</param>
        ...
        /// <summary>
        /// Replaces the current <see cref="BatchObservableCollection{T}"/> instance items with the 
        /// ones specified in the items collection, raising a single <see cref="NotifyCollectionChangedAction.Reset"/> event.
        /// </summary>
        /// <param name="items">The collection from which the items are copied.</param>
        /// <exception cref="ArgumentNullException">The items list is null.</exception>
        ...
        public void ReplaceRange(IEnumerable<T> items, int firstIndex, int oldSize)
        {
            ...
            using (SuppressEvents())
            {
                ...
                while (firstIndex + itemList.Count <= lastIndex)
                {
                    RemoveAt(lastIndex--);
                }
        ...
        /// <summary>
        /// Switches the current <see cref="BatchObservableCollection{T}"/> instance items with the ones specified in the items collection, raising the minimum required change events.
        /// </summary>
        /// <param name="items">The collection from which the items are copied.</param>
        /// <exception cref="ArgumentNullException">The items list is null.</exception>
        ...
        /// <summary>
        /// Removes the current <see cref="BatchObservableCollection{T}"/> instance items of the ones specified in the items collection, raising the minimum required change events.
        /// </summary>
        ...
        /// <summary>
        /// Removes the current <see cref="BatchObservableCollection{T}"/> instance items of the ones specified in the range, raising the minimum required change events.
        /// </summary>
